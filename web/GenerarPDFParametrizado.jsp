...
<html>
    ...
    <body>
        <% 
            ...
            //recibir el parametro que envian de algun lado
            String estado = request.getParameter("textEstado");
            //asignandole a parametro(mapeos) un nuevo parametro(estado)
            parametros.put("estado", estado);
            
            
            
            //necesitamos conecion (creamosobjeto de la clase conexion)
            Conexión claseconexion = new Conexión();
            //objeto tipo connection (obtenemos la conexion)
            Connection conexion = claseconexion.obtenerConexión();
